...
4. Đăng nhập tài khoản mặc định tại `/admin/login.php` với **admin / 123456** (tự động tạo nếu chưa có trong DB).
...
- **Quản trị**: đăng nhập/đăng xuất với tài khoản cố định admin/123456, tạo/sửa/xoá link, upload ảnh meta, tuỳ chỉnh meta title/description và nội dung hiển thị.
