...
- Trang admin (`/admin`) đăng nhập/đăng xuất (mặc định `admin/123456`), thêm/sửa link, reset lượt click từng link hoặc toàn bộ, chỉnh màu sắc và tiêu đề giao diện, thêm tài khoản admin mới.
