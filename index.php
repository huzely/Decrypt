...
if ($path === '' || $path === 'index.php') {
    ...
    <div class="container">
                ...
                <?php foreach ($links as $link): ?>
                    <div class="list-item">
                        ...
                        <div style="display:flex;gap:8px;flex-wrap:wrap;">
                            <a class="btn" href="<?php echo htmlspecialchars($baseUrl . '/' . $link['slug']); ?>" target="_blank">Đi tới link</a>
        ...
        <p style="text-align:center;"><a href="<?php echo htmlspecialchars($baseUrl); ?>/admin/login.php">Đăng nhập quản trị</a></p>
    </div>
    </body>
    </html>
    <?php
