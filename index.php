...
<head>
    ...
    <style>
        ...
        @media (max-width: 720px) {
            ...
            .hero { padding: 1.5rem; }
            .nav { flex-direction: column; align-items: flex-start; gap: 0.35rem; }
        }
    </style>
</head>
<body>
