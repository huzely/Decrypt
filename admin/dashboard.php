...
<header>
    <h1>Quản trị link</h1>
    <p class="subtitle">Xin chào <?php echo htmlspecialchars($_SESSION['admin_user']); ?> • <a href="/admin/logout.php">Đăng xuất</a></p>
</header>
<div class="container">
    ...
    <div class="grid cols-2">
        <div class="card">
            ...
            <form method="post" action="/admin/link_edit.php">
    ...
    <div class="card">
        <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                <a class="btn secondary" href="/admin/register.php">Thêm tài khoản admin</a>
                <a class="btn" href="/admin/link_edit.php">Tạo link mới</a>
            </div>
        </div>
        <table class="table">
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn" href="/admin/link_edit.php?id=<?php echo $link['id']; ?>">Sửa</a>
                        <form method="post" action="/admin/link_edit.php" style="display:inline" onsubmit="return confirm('Reset lượt click?');">
