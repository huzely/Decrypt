...
<div class="panel">
    ...
    <form method="post">
        <input type="text" name="username" placeholder="Tên đăng nhập" required value="<?php echo sanitize(DEFAULT_ADMIN_USERNAME); ?>">
        <input type="password" name="password" placeholder="Mật khẩu" required value="<?php echo sanitize(DEFAULT_ADMIN_PASSWORD); ?>">
        <button type="submit">Đăng nhập</button>
    </form>
    <p style="margin-top:0.5rem;">Tài khoản mặc định: <strong><?php echo sanitize(DEFAULT_ADMIN_USERNAME); ?></strong> / <strong><?php echo sanitize(DEFAULT_ADMIN_PASSWORD); ?></strong></p>
</div>
</body>
</html>
