...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $_SESSION['flash'] = $msg;
    header('Location: ' . ($_POST['id'] ? ($baseUrl . '/admin/link_edit.php?id=' . (int)$_POST['id']) : ($baseUrl . '/admin/link_edit.php')));
    exit;
}
...
<header>
    ...
    <p class="subtitle"><a href="<?php echo htmlspecialchars($baseUrl); ?>/admin/dashboard.php">← Quay lại bảng điều khiển</a></p>
</header>
<div class="container">
    <div class="card">
        <form method="post" enctype="multipart/form-data">
            ...
            <?php if (!empty($link['meta_image'])): ?>
                <p class="subtitle">Ảnh hiện tại: <a href="<?php echo htmlspecialchars($baseUrl . '/' . $link['meta_image']); ?>" target="_blank">Xem</a></p>
