...
2. Nếu có `ad_link`:
   ...
   - Bấm ĐÓNG: hành vi tương tự (mở tab bài ad=0, redirect Shopee).
   - Truy cập trực tiếp bài (không `?ad=0`): overlay xuất hiện, click overlay hoặc nút đóng sẽ mở tab mới `/{slug}?ad=0` và tab hiện tại nhảy sang Shopee.
