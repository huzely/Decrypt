...
<form method="POST" enctype="multipart/form-data">
    ...
    <label><input type="checkbox" name="ads_enabled" value="1" <?php echo ($settings['ads_enabled']??0)?'checked':''; ?>> Bật quảng cáo Shopee</label>
    <label>Link quảng cáo</label>
    <input name="ad_link" value="<?php echo e($settings['ad_link']); ?>">
