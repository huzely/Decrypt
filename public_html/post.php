...
<?php if (!empty($settings['ads_enabled']) && !empty($settings['ad_link']) && empty($_GET['ad'])): ?>
initAdFlow({
    disabled:false,
    link:'<?php echo e($settings['ad_link']); ?>',
    title:'<?php echo e($settings['ad_title'] ?? 'Ưu đãi Shopee'); ?>',
    body:'<?php echo e($settings['ad_body'] ?? 'Nhấn để xem ngay'); ?>',
