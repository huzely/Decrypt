...
ALTER TABLE telegram_queue ADD UNIQUE KEY uq_type (type);
INSERT INTO telegram_queue (type, counter, last_sent_at) VALUES ('click', 0, NOW())
  ON DUPLICATE KEY UPDATE last_sent_at = last_sent_at;

INSERT INTO admins (username, password_hash) VALUES ('admin', '$2y$12$XcNEc95USbC7DRJ4q05Vr.eJ9XvNw.zKfxv.4T1mheeOVuIG701pS');
